        ...
        <div className="container-fluid pt-2" >
          <div className="row footer-area">
            <div className="col-lg-4 col-md-6 col-sm-6 mb-5">
              <h6>About Us</h6>
              <p>Welcome to BookHub, where the love for literature meets the convenience of modern technology. At BookHub, we believe in the transformative power of books and their ability to connect, inspire, and enrich our lives. </p>
            </div>
